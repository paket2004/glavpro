...
if st.button("Сохранить таблицу и текст в Word"):
    ...
    По своему функциональному назначению санитарно-защитная зона является защитным барьером, обеспечивающим уровень безопасности населения при эксплуатации объекта в штатном режиме. СЗЗ устанавливается в целях:
